...
| Week | Topic |
|------|-------|
|  34    |  <ul><li> [Introduction](introduction.md) <ul><li>[Basic Structure](basic_structure.md)</li><li>[Control Statements](control_statements.md)</li><li>[Variables and Basic Types](variables.md)</li><li>[Functions](functions.md)</li></ul> <li>[Getting Started](getting_started.md)</li> </li></ul>     |         
