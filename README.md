...
|  43    | <ul> <li>[Separation of Concerns](Chapter5/soc.md)</li><li> [Observer Pattern](Chapter5/observer.md) </li><li> [Testing](Chapter5/testing.md) </li><li> [Error Handling](Chapter5/error_handling.md) </li> </ul> |
