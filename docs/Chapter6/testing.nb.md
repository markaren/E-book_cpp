...
- **Den strekker seg ut mot maskinvare, filer, klokka eller nettverket** — tett **kobling**, med skjulte inndata. Løsningen er **avhengighetsinjeksjon**: ta imot de avhengighetene (som parametere, eller bak et grensesnitt) i stedet for å opprette dem innvendig, slik at en test kan sende inn en fake — verdt å se i sin helhet, straks.
