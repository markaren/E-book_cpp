...
| **composition** | Building a class by holding another as a *member* (a "has-a") instead of inheriting from it. Prefer it to inheritance unless the relationship is a genuine "is-a." See [Polymorphism](Chapter5/polymorphism.md). |
