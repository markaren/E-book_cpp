...
| **komposisjon** | Å bygge en klasse ved å holde en annen som et *medlem* (en "has-a") i stedet for å arve fra den. Foretrekk det fremfor arv med mindre forholdet er en ekte "is-a". Se [Polymorfisme](Chapter5/polymorphism.md). |
